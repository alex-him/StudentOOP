...
void print_vec(const string name, const vector<DATA> vec){
    cout << name << ": ";
 ...
 * */
template<typename DATA>
void print_list(const string name, const list<DATA> lst){
    cout << name << ": ";
    for(auto v: lst){
        cout << v << " ";}
    cout << endl;
...
void print(const string name, const Container cnt){
    cout << name << ": ";
    for(auto v: cnt){
        cout << v << " ";}
    cout << endl;
...
int main() {
     ...
     * */
    cout << "The beginning od ilist is: " << *ilist.begin() << endl;
    cout << "The beginning od ilist is: " << *ilist.end() << endl;
    
    /*
     * Here we are going to pass `is_odd()` to `find_if()`.
     * */
    list<int>::iterator odd_iter = find_if(ilist.begin(), ilist.end(), is_odd);
    cout << "The first odd number in ilist is: " << *odd_iter << endl;
    odd_iter++;
     ...
     * */
    list<int>::iterator odd_iter2 = find_if(ilist.begin(), ilist.end(), IsOdd());
    cout << "The first odd number in ilist is: " << *odd_iter2 << endl;
    odd_iter2++;
     ...
     * */
    list<int>::iterator odd_iter3 = find_if(ilist.begin(), ilist.end(), [](int n) -> bool {return (n % 2) == 1; });
    cout << "The first odd number in ilist is: " << *odd_iter3 << endl;
    odd_iter3++;
